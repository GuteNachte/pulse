...
services:
  pulse-hub:
    image: registry.example.com/infra/pulse-hub:1.0.6-beta.4
  ...
  pulse-agent:
    image: registry.example.com/infra/pulse-agent:1.0.6-beta.4
...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File supplemental\scripts\publish-release-v1.ps1 -Version 1.0.6-beta.4
```
