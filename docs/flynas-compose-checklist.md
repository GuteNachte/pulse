...
- Hub 镜像：`registry.example.com/infra/pulse-hub:1.0.5`
- Agent 镜像：`registry.example.com/infra/pulse-agent:1.0.5`
...
```bash
docker pull registry.example.com/infra/pulse-hub:1.0.5
docker pull registry.example.com/infra/pulse-agent:1.0.5
```
