...
- Hub 镜像：`registry.example.com/infra/pulse-hub:1.0.6-beta.3`
- Agent 镜像：`registry.example.com/infra/pulse-agent:1.0.6-beta.3`
...
```bash
docker pull registry.example.com/infra/pulse-hub:1.0.6-beta.3
docker pull registry.example.com/infra/pulse-agent:1.0.6-beta.3
```
