...
- Hub 镜像：`registry.example.com/infra/pulse-hub:1.0.6-beta.4`
- Agent 镜像：`registry.example.com/infra/pulse-agent:1.0.6-beta.4`
...
```bash
docker pull registry.example.com/infra/pulse-hub:1.0.6-beta.4
docker pull registry.example.com/infra/pulse-agent:1.0.6-beta.4
```
